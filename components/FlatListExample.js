...
class FlatListExample extends React.Component {
  ...
  renderItem = ({ item, index }) => {
    return (
      <View style={{ height: 200, backgroundColor: 'purple', justifyContent: 'center' }}>
        <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 20, color: 'white' }} >flatlist item {index}</Text>
      </View>
    )
  }
